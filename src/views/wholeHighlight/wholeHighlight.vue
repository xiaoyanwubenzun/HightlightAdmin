...
<!--                    >-->
<!--&lt;!&ndash;                        <div class="user-img-and-name">&ndash;&gt;-->
<!--&lt;!&ndash;                            <img&ndash;&gt;-->
<!--&lt;!&ndash;                                    class="user-img"&ndash;&gt;-->
<!--&lt;!&ndash;                                    :src="item.user_img"&ndash;&gt;-->
<!--&lt;!&ndash;                                    alt="头像加载失败"&ndash;&gt;-->
<!--&lt;!&ndash;                            />&ndash;&gt;-->
<!--&lt;!&ndash;                            <span @click.stop="watchThisUser(item.uid)">{{item.user_name}}</span>&ndash;&gt;-->
<!--&lt;!&ndash;                            <i><img :src="item.gender" alt="性别图标加载失败" /></i>&ndash;&gt;-->
<!--&lt;!&ndash;                            <span class="user-sign">签名：{{ item.user_sign }}</span>&ndash;&gt;-->
<!--&lt;!&ndash;                        </div>&ndash;&gt;-->
