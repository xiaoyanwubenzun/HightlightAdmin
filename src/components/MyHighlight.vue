<!--<template>-->
<!--	<div>-->
<!--		<HighlightHeader @send="getUserInfo" class="myhightlightheader"></HighlightHeader>-->
<!--		<div class="myhightlight" :style="backgroundStyle">-->
<!--			<div class="emptyblock"></div>-->
<!--			<div class="usermessagehead">-->
<!--				<div v-if="user_info.username" class="whosmessage">-->
<!--					<img-->
<!--						class="whosuserimg"-->
<!--						:src="user_info.userimg"-->
<!--						alt="图片加载中"-->
<!--					/>-->
<!--					<span class="whosname">{{ user_info.username }}</span>-->
<!--					<i class="whosgender"-->
<!--						><img :src="user_info.gender" alt="图片加载中"-->
<!--					/></i>-->
<!--					<i class="whosage"-->
<!--						><span>{{ user_info.uage }}</span></i-->
<!--					>-->
<!--					<span class="zonghepaiming"-->
<!--						>本站贡献排名：{{ user_info.paiming }}</span-->
<!--					>-->
<!--				</div>-->
<!--				<div v-if="user_info.username" class="whossignwnumlikenumvnum">-->
<!--					<p class="whossign">签名：{{ user_info.usersign }}</p>-->
<!--					<ul class="clearfloat">-->
<!--						<li>-->
<!--							<i class="el-icon-video-camera"></i-->
<!--							><span-->
<!--								>发布集锦：<i>{{ user_info.vnum }}</i></span-->
<!--							>-->
<!--						</li>-->
<!--						<li>-->
<!--							<i class="el-icon-star-off"></i-->
<!--							><span-->
<!--								>获得点赞：<i>{{ user_info.likenum }}</i></span-->
<!--							>-->
<!--						</li>-->
<!--						<li>-->
<!--							<i class="el-icon-view"></i-->
<!--							><span-->
<!--								>集锦被浏览总量：<i>{{ user_info.wnum }}</i></span-->
<!--							>-->
<!--						</li>-->
<!--					</ul>-->
<!--				</div>-->
...
<!--				<div class="videolist">-->
<!--					&lt;!&ndash; v-for="item in videolist" :key="item.vid" &ndash;&gt;-->
<!--					<div-->
...
<!--							if (item.uid === this.user_info.uid) {-->
<!--								this.user_info = item;-->
<!--								this.user_info.paiming = index + 1;-->
<!--								switch (item.gender) {-->
<!--									case 0:-->
