...
<!--							alt="头像加载失败"-->
<!--						/>-->
<!--						<span @click.stop="watchVideo(item.uid)">{{-->
<!--							item.username-->
<!--						}}</span>-->
<!--						<i><img :src="item.gender" alt="性别图标加载失败" /></i>-->
<!--						<span class="user-sign">签名：{{ item.usersign }}</span>-->
<!--					</div>-->
...
<!--						this.user_list.forEach((item, index, user_list) => {-->
<!--							switch (item.gender) {-->
<!--								case 0:-->
...
<!--			watchVideo(uid) {-->
<!--				this.$router.push(`/my-highlight?uid=${uid}`);-->
<!--			},-->
